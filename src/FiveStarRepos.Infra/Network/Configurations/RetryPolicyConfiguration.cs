        ...
        public static class RetryPolicyConfiguration
        {
            ...
            public static IAsyncPolicy<HttpResponseMessage> GetRetryPolicy(IConfiguration configuration)
            {
                ...
                return HttpPolicyExtensions.HandleTransientHttpError()
                                           .WaitAndRetryAsync(retryCount: tentativas, sleepDurationProvider: retryAttempt => TimeSpan.FromSeconds(Math.Pow((intervalo / 1000), retryAttempt)) + TimeSpan.FromMilliseconds(Jitter.Next(0, 100)));
            }
        }
    }
}
